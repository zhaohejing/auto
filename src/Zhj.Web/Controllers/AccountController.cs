...
namespace MyCompanyName.AbpZeroTemplate.Web.Controllers
{
    public class AccountController : AbpZeroTemplateControllerBase
    {
        ...
        public virtual async Task<JsonResult> Login(LoginViewModel loginModel, string returnUrl = "",
            ...
            var res = loginResult.Result;
            if (res==AbpLoginResultType.Success) {
                ...
                return Json(new MvcAjaxResponse { TargetUrl = returnUrl, Result = res });
            }
                return Json(new MvcAjaxResponse { Result = res });
