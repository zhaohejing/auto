    ...
    return {
        ...
        link: function(scope, element, attrs, tagsInputCtrl) {
            ...
            scope.$getDisplayText = function () {
                if (options.displayProperty=="inCard") {
                    return tiUtil.safeToString(decodeURIComponent( scope.data[options.displayProperty]));
                }
...
tagsInput.run(["$templateCache", function($templateCache) {
    ...
    $templateCache.put('ngTagsInput/tag-item.html',
      //  '<p ng-bind="$getDisplayText()" ng-click="$removeTag()"></p>'
    "<span ng-bind=\"$getDisplayText()\"></span> <a class=\"remove-button\" ng-click=\"$removeTag()\" ng-bind=\"::$$removeTagSymbol\"></a>"
  );

  $templateCache.put('ngTagsInput/auto-complete.html',
    "<div class=\"autocomplete\" ng-if=\"suggestionList.visible\"><ul class=\"suggestion-list\"><li class=\"suggestion-item\" ng-repeat=\"item in suggestionList.items track by item.id\" ng-class=\"getSuggestionClass(item, $index)\" ng-click=\"addSuggestionByIndex($index)\" ng-mouseenter=\"suggestionList.select($index)\"><ti-autocomplete-match scope=\"templateScope\" data=\"::item\"></ti-autocomplete-match></li></ul></div>"
  );
