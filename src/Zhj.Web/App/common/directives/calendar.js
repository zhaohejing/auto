! function () {
    ...
    function Calendar(selector, events, clicks) {
    ...
    Calendar.prototype.drawHeader = function () {
        ...
        if (!this.header) {
            ...
            var right = createElement('div', 'right', '下一月');
            right.addEventListener('click', function () {
                self.nextMonth();
            });

            var left = createElement('div', 'left', '上一月');
    ...
    Calendar.prototype.drawDay = function (day) {
        ...
        if (todayEvents) {
            ...
            circle.style.webkitTransform = 'scale(0.5)';
            circle.style.MozProperty = 'scale(0.5)';
    ...
    Calendar.prototype.renderEvents = function (events, ele) {
        ...
        events[0].events.forEach(function (ev) {
            ...
            var square = createElement('div', 'event-category ' + (ev.type == 2 ? 'blue' : 'yellow'));
    ...
    Calendar.prototype.reLoad = function (a) {
        this.events = a;
        this.draw();
    }
...
appModule.directive('calendar', [function () {
    return {
        ...
        link: function (scope, element, attributes) {
            ...
            var calendar = new Calendar('#calendar', scope.datemodel, scope.events);
            scope.$watch('mlength', function (n, v) {
                var data = scope.datemodel;

                if (n != v) {
                    calendar.reLoad(data);
                }
            })
