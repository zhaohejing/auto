(function () {
    appModule.directive('selectSearch', function ($compile) {
        return {
            ...
            '<div  ng-hide="hidden">' +
            '   <select class="form-control input-inline" ng-change="change(x)" ng-model="x"'+
            ' ng-options="x.id as x.value for x in datas"></select>'+
            '</div>',
            //   replace: true,  
